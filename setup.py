...
def setup_db():
    ...
    cur.execute(
        ...
        CREATE TABLE IF NOT EXISTS MATCH (
            ...
            winning_team_score INT NOT NULL CHECK (winning_team_score == 3 OR winning_team_score == 10),
            losing_team_score INT NOT NULL CHECK (losing_team_score >= 0 AND losing_team_score != 10)
        );
